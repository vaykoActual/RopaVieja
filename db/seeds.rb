...
Product.create!(name: 'Viking Hat', imgURL: 'https://i.imgur.com/SKV27n3.jpeg', user: @ruby, categories: [@men, @women])
Product.create!(name: 'Surviaval Jacket', imgURL: 'https://i.imgur.com/rCO3goF.jpeg', user: @ruby, categories: [@men, @women])
Product.create!(name: '3000 year old Pants', imgURL: 'https://i.imgur.com/wpa1aQ0.jpg', user: @ruby, categories: [@men, @women])
